...
contactsRouter.post('/', checkRoles(USER_ROLES.ADMIN, USER_ROLES.USER), validateBody(createContactSchema), ctrlWrapper(addContactController));
contactsRouter.delete('/:contactId', isValidId, checkRoles(USER_ROLES.ADMIN), ctrlWrapper(deleteContactController));
contactsRouter.patch('/:contactId', isValidId, checkRoles(USER_ROLES.USER, USER_ROLES.ADMIN), validateBody(updateContactSchema), ctrlWrapper(updatePatchContactController));
